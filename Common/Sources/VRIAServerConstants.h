...
#define K_CURRENT_PROTOCOL_VERSION "WAKANDA_SUPERVISOR_v1.3_MAIN"
...
const XBOX::VError	VE_RIA_CANNOT_OPEN_DESIGN_SOLUTION				= MAKE_VERROR( kRIA_OSTYPE_SIGNATURE, 1094);
...
const XBOX::VError	VE_RIA_JS_DISABLED_PROPERTY						= MAKE_VERROR( kRIA_OSTYPE_SIGNATURE, 1093);
...
//restoreDataStore() syntax errors
const XBOX::VError	VE_RIA_PROPERTY_NOT_FOUND						= MAKE_VERROR(kRIA_OSTYPE_SIGNATURE, 1092);
