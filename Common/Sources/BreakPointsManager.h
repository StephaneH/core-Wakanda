...
*/
#ifndef __BREAKPOINTSMANAGER__
#define __BREAKPOINTSMANAGER__

typedef XBOX::VSignalT_0	VSignal_UpdateBreakPoints;

// ----------------------------------------------------------------------------
// Interface pour decoupler les classes VSolution et VBreakPointManager
// ----------------------------------------------------------------------------
class VSolution;
...
public:
	...
	virtual void							UpdateBreakPoints( const XBOX::VString& inBreakpoints ) = 0;
	virtual VSignal_UpdateBreakPoints&		GetSignalUpdateBreakPoints() = 0;
	virtual void GetBreakPoints( XBOX::VString& outJSON ) = 0;
	virtual void GetBreakPointsForRPC( XBOX::VString& outJSON ) = 0;
