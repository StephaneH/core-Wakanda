...
namespace ProjectItemBagKeys
{
	...
	EXTERN_BAGKEY_WITH_DEFAULT( tabPosition, XBOX::VString );
}
...
const XBOX::VError VE_SOMA_REFERENCED_SOLUTION_FILE_NOT_FOUND = MAKE_VERROR(kSOLUTION_MANAGER_SIGNATURE, 1014);
