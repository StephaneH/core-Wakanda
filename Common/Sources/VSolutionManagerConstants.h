...
namespace ProjectItemBagKeys
{
	...
	EXTERN_BAGKEY_WITH_DEFAULT_SCALAR( startupProject, XBOX::VBoolean, bool);
...
#define EDITOR_TABS_UPDATE					CVSTR("editor.update")
...
#define INTRO_REMOTECATALOG		"{\"remoteAccess\":{\"hostname\":\"\",\"user\":\"\",\"password\":\"\",\"SQL\":false},\"dataClasses\":[], \"toJSON\":true}"
...
// ----------------------------------------------------------------------------
// Icons : pour de nouvelles icones, rajouter a la fin (sinon, il faut modifier
// tous les indices dans VProjectItemIconManager::_InitMap_ProjectItemIcon())
// ----------------------------------------------------------------------------
static const char* arProjectItemsIcons2[] = {
		// !!! CONSERVE CORRESPONDANCE WITH !!!
		// VSolutionExplorerDelegate.h "e_ProjectItemBasicKind" TABLE
			"file:Images/SolutionManager/undefined.png",
			"file:Images/SolutionManager/solution.png",
			"file:Images/SolutionManager/project.png",
			"file:Images/SolutionManager/folder.png",
			"file:Images/SolutionManager/settings.png",
			"file:Images/SolutionManager/log.png",
			"file:Images/SolutionManager/catalog.png",
			"file:Images/SolutionManager/remoteCatalog.png",
			...
			"file:Images/SolutionManager/html.png",
			"file:Images/SolutionManager/javascript.png",
			"file:Images/SolutionManager/json.png",
			"file:Images/SolutionManager/php.png",
			"file:Images/SolutionManager/sql.png",
			"file:Images/SolutionManager/texte.png",
			...
			"file:Images/SolutionManager/widgets.png",
			"file:Images/SolutionManager/themes.png"
...
const XBOX::VString kSOMA_DELETE_WARNING = "delete_warning";
...
#define SOLUTION_PROFILING_ENABLED 0
enum
{
	PROFILER_CALL_VProject_SynchronizeWithFileSystem = 0,
	PROFILER_CALL_VProjectItem_ConformsTo,
	PROFILER_CALL_VSolutionExplorerDialog__LoadStandardListBox,
	PROFILER_CALL_ISolutionDelegate_Synchronize,
	PROFILER_CALL_VProject_GetProjectItemFromFullPath,
	PROFILER_CALL_VProjectItem_BuildFullPath,
	PROFILER_CALL_VProject__SynchronizeWithFileSystem,
	PROFILER_CALL_VProject_RegisterProjectItemInMapOfFullPathes,
	PROFILER_CALL_VFile_ConformsTo,
	PROFILER_CALL_VSolutionExplorerDialog__MakeViewFromTreeSolution,
	PROFILER_CALL_VSolutionExplorerDialog__SetTreemItemPropertiesFromProjectItem,
	PROFILER_CALL_VProjectItem_FindChildByRelativePath
};
