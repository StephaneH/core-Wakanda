...
function displayDatastore() {
    ...
    txt_html +=             '<input id="flushDataCacheInterval" type="text" class="numeric" size="10" min="1"/> seconds';
    ...
    txt_html +=             '<input id="fixedSize" type="text" class="number" min="0" step="100"/> MB';   
	txt_html +=             '<div class="plus stepper inline"/><div class="min stepper inline"/>';
    txt_html +=         '</div>';
    ...
    txt_html +=             '<input id="memoryForOtherApplications" type="text" class="numeric" size="8" min="0" step="512"/> MB';
	txt_html +=             '<div class="plus stepper inline"/><div class="min stepper inline"/>';
    txt_html +=         '</div>';
    ...
    txt_html +=             '<input id="memoryForCache" type="text" class="numeric" size="8" min="0" max="100" step="5"/> %';
	txt_html +=             '<div class="plus stepper inline"/><div class="min stepper inline"/>';
    txt_html +=         '</div>';
    ...
    txt_html +=             '<input id="minimumSize" type="text" class="numeric" size="8" min="0" step="100"/> MB';    
	txt_html +=             '<div class="plus stepper inline"/><div class="min stepper inline"/>';
    txt_html +=         '</div>';
    ...
    txt_html +=             '<input id="maximumSize" type="text" class="numeric" size="8" min="0" step="100"/> MB';    
	txt_html +=             '<div class="plus stepper inline"/><div class="min stepper inline"/>';
    txt_html +=         '</div>';
