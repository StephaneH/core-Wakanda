if (NOT MSVC)
	...
	if (OPENSSL_FOUND)
		...
		set(OpenSSLSystemIncludeDir ${OPENSSL_INCLUDE_DIRES})
		set(OpenSSLSystemLibs       ${OPENSSL_LIBRARIES})
...
if (MONOLITIC)
	...
	ExternalProject_Add(
		...
		STAMP_DIR           ${OpenSSLRoot}/build/${BRANCH_l}${CMAKE_BUILD_TYPE}${ARCH_TAG}/stamps
		DOWNLOAD_COMMAND    true
		SOURCE_DIR          ${OpenSSLRoot}/build/${BRANCH_l}${CMAKE_BUILD_TYPE}${ARCH_TAG}/openssl
		CONFIGURE_COMMAND   ../../../WakandaSetup.sh build/${BRANCH_l}${CMAKE_BUILD_TYPE}${ARCH_TAG}
		                    ${OpenSSLArchFlags}
	...
	foreach(lib crypto ssl)
		...
		set_property(TARGET ${lib} PROPERTY IMPORTED_LOCATION ${OpenSSLRoot}/build/${BRANCH_l}${CMAKE_BUILD_TYPE}${ARCH_TAG}/openssl/lib${lib}.so.1.0.0)
		message(STATUS "Add OpenSSL autotools lib: ${lib}")
	endforeach()

	set(OpenSSLIncludeDir	${OpenSSLRoot}/build/${BRANCH_l}${CMAKE_BUILD_TYPE}${ARCH_TAG}/openssl/include)
