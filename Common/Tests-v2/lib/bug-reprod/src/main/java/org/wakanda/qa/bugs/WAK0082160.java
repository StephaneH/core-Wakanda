 ...
 * 
 */
public class WAK0082160 {

	private static Logger logger = Logger.getLogger(WAK0082160.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String data = null;
		String resourceName = "toCheckRange.tmp";
		...
		// Range
		Header hRange = new BasicHeader(HttpHeaders.RANGE, "bytes=148-51");
