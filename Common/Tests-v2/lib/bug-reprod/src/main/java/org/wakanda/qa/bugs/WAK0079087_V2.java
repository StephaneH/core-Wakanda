 ...
 * 
 */
public class WAK0079087_V2 {

	private static Logger logger = Logger.getLogger(WAK0079087_V2.class);
	...
	public static void main(String[] args) throws Exception {
		...
		assertTrue("Server not started of solution not opened", Configuration.getInstance().getSeverAdmin().isSolutionDeployed());
