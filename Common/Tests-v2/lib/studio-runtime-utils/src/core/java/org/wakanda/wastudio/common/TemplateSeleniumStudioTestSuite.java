...
public class TemplateSeleniumStudioTestSuite {
    protected static Logger logger = Logger.getLogger(TemplateSeleniumStudioTestSuite.class);
	...
	try {
		...
		file = new File(Paths.appStudio.substring(0,Paths.appStudio.lastIndexOf("\\"))
	    ...
	    logger.error("GUID not restored to default");
	}
