...
if (typeof env !== 'undefined' && typeof env.BUILD_TEST_DIR !== 'undefined') 
	var installerPath = env.BUILD_TEST_DIR;
else 
	var installerPath = 'C:\\Users\\yjego\\Desktop\\installeurWin';
...
installerCommunityPath = installerPath+'\\Installer.msi';
installerEnterprisePath = installerPath+'\\InstallerEnterprise.msi';
