...
testCase.testEnterprise_checkStudioShortcuts = function () {
	var result = build.getTargetPathofShortcut(publicPath+'Wakanda Enterprise Studio.lnk');
	Y.Assert.areSame(wakandaEnterprisePath_posix+'Studio/Wakanda Studio.exe', result, 'Wakanda Studio.lnk does not have the right path');
};

testCase.testEnterprise_checkServerShortcuts = function () {
	var result = build.getTargetPathofShortcut(publicPath+'Wakanda Enterprise Server.lnk');
	Y.Assert.areSame(wakandaEnterprisePath_posix+'Server/Wakanda Server.exe', result, 'Wakanda Server.lnk does not have the right path');
};
...
testCase.testEnterprise_checkWaDirectoryIcon = function () {
	...
	Y.Assert.areSame(wakandaEnterprisePath_posix+'Studio/Wakanda_docEnterprise.ico', result);
};
...
testCase.testEnterprise_checkWaDirectoryAssociations = function () {
	...
	Y.Assert.areSame(wakandaEnterprisePath_posix+'Studio/Wakanda Studio.exe "%*"', result);
};
