...
testCase.testEnterprise_server_checkBundle_LDAPComponent = function () {
	var file = File(wakandaEnterprisePath_posix+"Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf")
	Y.Assert.areSame(true, file.exists, 'Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf');
	
	file = File(wakandaEnterprisePath_posix+"Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf")
	Y.Assert.areSame(true, file.exists, 'Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf');

	file = File(wakandaEnterprisePath_posix+"Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf")
	Y.Assert.areSame(true, file.exists, 'Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf');
	
	file = File(wakandaEnterprisePath_posix+"Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf")
	Y.Assert.areSame(true, file.exists, 'Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf');
