...
testCase.testCommunity_studio_checkBundle_LDAPComponent = function () {
	var file = File(wakandaCommunityPath_posix+"Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf")
	Y.Assert.areSame(false, file.exists, 'Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf');
	
	file = File(wakandaCommunityPath_posix+"Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf")
	Y.Assert.areSame(false, file.exists, 'Server/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf');

	file = File(wakandaCommunityPath_posix+"Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf")
	Y.Assert.areSame(false, file.exists, 'Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponent.xlf');
	
	file = File(wakandaCommunityPath_posix+"Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf")
	Y.Assert.areSame(false, file.exists, 'Studio/Native Components/LDAPComponent.bundle/Contents/Resources/en.lproj/LDAPComponentEN.xlf');
};
