...
import static com.wakanda.qa.http.Resources.executeRequest;
import static com.wakanda.qa.http.Resources.getDefaultTarget;
import static com.wakanda.qa.http.Resources.getSolutionPath;
import static com.wakanda.qa.http.Resources.getWakandaServerPathEVName;
import static com.wakanda.qa.http.Resources.getWebAdminTarget;
...
public class ServerUtil {
	...
	public static boolean runTheServerAndWait(long millis) {
	...
	public static boolean isServerResponding() {
		...
		try {
			HttpResponse response = executeRequest(new HttpGet("/"),
					getWebAdminTarget());
	...
	public static boolean isSolutionDeployed(HttpHost target) {
		...
		try {
			HttpResponse response = executeRequest(new HttpGet("/"), target);
			boolean is200Ok = response.getStatusLine().getStatusCode() == HttpStatus.SC_OK;
			boolean isWakanda = response.getFirstHeader(HttpHeaders.SERVER)
					.getValue().contains("Wakanda");
