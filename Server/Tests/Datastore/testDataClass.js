...
var testCase = {
    ...
    testCompute_ExistenceOfAverageDistinctPropertyInReturnedObject: function() {
        Y.Assert.areSame(14.75,ds.MyClass1.compute('cnum',true).cnum.average_distinct, "The attribute average_distinct does not work.");
    },
    ...
    testCompute_ExistenceOfCountDistinctPropertyInReturnedObject: function() {
        Y.Assert.isNumber(ds.MyClass1.compute('cnum',true).cnum.count_distinct, "The attribute count_distinct does not exists.");
    },
    ...
    testCompute_ExistenceOfSumDistinctPropertyInReturnedObject: function() {
        Y.Assert.areSame(118,ds.MyClass1.compute('cnum',true).cnum.sum_distinct, "The attribute sum_distinct does not work.");
    },
    ...
    testCompute_SyntaxBadParamWithoutDistinction: function() {
        ...
        Y.Assert.isNull(ds.MyClass1.compute(','), "Syntax failed :ds.MyClass1.compute(',').");
	...
	testCompute_SyntaxBadParamWithDistinction: function() {
        ...
        Y.Assert.isNull(ds.MyClass1.compute(',',true), "Syntax failed :ds.MyClass1.compute(',').");
    ...
    testCompute_BadAttributeParamTypeDuration: function() {
		...
		Y.Assert.areSame(2,ds.MyClass1.compute("cduration").cduration.average,"Syntax failed : ds.MyClass1.compute(duration).cduration.average");
    ...
    testCompute_DataClassAttributeAsEmptyString: function() {
        Y.Assert.isNull(ds.MyClass1.compute(''), "compute empty param failed.");
    },
    ...
    testCompute_DistinctAverageOfDataClassWithData: function() {
        Y.Assert.areSame(14.75, ds.MyClass1.compute('cnum',true).cnum.average_distinct, "compute average_distinct failed.");
    },
    ...
    testCompute_DistinctCountOfDataClassWithData: function() {
        Y.Assert.areSame(8, ds.MyClass1.compute('cnum',true).cnum.count_distinct, "compute count_distinct failed.");
    },
    ...
    testCompute_DistinctSumOfDataClassWithData: function() {
        Y.Assert.areSame(118, ds.MyClass1.compute('cnum',true).cnum.sum_distinct, "compute sum_distinct failed.");
    },
    //the sum of num is > 2147483647.
    ...
    testCompute_DistinctAverageOfDataClassWithDataSumGreaterThan2147483647: function() {
        Y.Assert.areSame(2147483646, ds.MyClass2.compute('cnum',true).cnum.average_distinct, "compute average_distinct with sum > 2147483647 failed.");
    },
    ...
    testCompute_DistinctSumOfDataClassWithDataSumGreaterThan2147483647: function() {
        Y.Assert.areSame(4294967292, ds.MyClass2.compute('cnum',true).cnum.sum_distinct, "compute sum_distinct failed.");
    },
    ...
    testCompute_DataClassWithoutData: function() {
        ...
        Y.Assert.isNull(ds.MyEmptyClass.compute('cnum',true).cnum.average_distinct, "compute distinct average collection failed.");
        ...
        Y.Assert.areSame(0,ds.MyEmptyClass.compute('cnum',true).cnum.sum_distinct, "compute sum distinct collection failed.");
    },
    //collection
    testCompute_ComputeCollectionWithData: function() {
        ...
        Y.Assert.areSame(13 / 3, myCollection.compute('cnum',true).cnum.average_distinct, "compute distinct average collection failed.");
        ...
        Y.Assert.areSame(13, myCollection.compute('cnum',true).cnum.sum_distinct, "compute sum distinct collection failed.");
    },
    //empty collection (WAK0071945 Bug)
    testCompute_CollectionWithoutData: function() {
        ...
        Y.Assert.isNull(myEmptyCol.compute('cnum',true).cnum.average_distinct, "compute distinct average collection failed.");
        ...
        Y.Assert.areSame(0,myEmptyCol.compute('cnum',true).cnum.sum_distinct, "compute sum distinct collection failed.");
    },
    //Existence
    ...
    testDistinctValues_InexistantAttributeParam: function() {
        Y.Assert.isNull(ds.MyClass1.distinctValues('myInexistantAttribute'), "Inexistant attribute failed.");
    },
    //other class attribute (WAK0072036 Bug)
    ...
    testDistinctValues_DataClassAttributeAsEmptyString: function() {
        Y.Assert.isNull(ds.MyClass1.distinctValues(''), "Existence failed.");
    },
    ...
    testOrderBy_SameAttributeTwiceDesc: function() {
        ...
        if (orderByError != "")
            Y.Assert.fail(orderByError);
        entityColDesc = ds.MyOrderbyClass.orderBy(ds.MyOrderbyClass.cnum, ds.MyOrderbyClass.cnum, 'desc');
