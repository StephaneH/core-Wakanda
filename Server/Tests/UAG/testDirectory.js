...
var _testCase = {
    ...
    testFilterUsersMethodLogic1: function() {
        ...
        Y.Assert.areSame(3, actual.length);
    ...
    testSaveLogic: function() {
        // add a user
        var grpName = "toCkeckSaveMethod";
        directory.addUser(grpName);
        // save
        ...
        var expr = xpathParse("count(//user[@name='" + grpName + "'])");
        expr.evaluate(ctx).numberValue();
    },
