...
--
-- Base de donnÈes: `testdb_mac`
--

-- manualy added

DROP DATABASE IF EXISTS testdb_mac;

CREATE DATABASE IF NOT EXISTS testdb_mac;
...
INSERT INTO `test_big_int` VALUES (1,-9223372036854775000),(2,0),(3,9223372036854775000);
