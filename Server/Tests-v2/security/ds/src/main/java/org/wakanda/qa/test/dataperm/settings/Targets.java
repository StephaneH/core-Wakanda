...
public class Targets{
	...
	private static HttpHost getTarget(String name) {
		int port = Utils.getPropertiesConfiguration(Targets.class, "targets.properties").getInt(name);
		String hostName = Configuration.getInstance().getSettings().getDefaultTargetName();
