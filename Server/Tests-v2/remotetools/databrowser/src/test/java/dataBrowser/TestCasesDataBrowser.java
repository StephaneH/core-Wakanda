...
public class TestCasesDataBrowser extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		  ...
		  Paths.solutionRelativePath = "/solutions/dataBrowser/dataBrowser Solution/dataBrowser.waSolution"; 
		  String solutionPath = Common.getResourcePath(TestSuiteRemoteToolsDataBrowser.class, Paths.solutionRelativePath);
