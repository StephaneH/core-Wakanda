...
public class TestCasesAdmin extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		  ...
		  Paths.solutionRelativePath = "/solutions/adminSol/adminSol Solution/adminSol.waSolution"; 
		  String solutionPath = Common.getResourcePath(TestSuiteRemoteToolsAdmin.class, Paths.solutionRelativePath);
	...
	public void remoteTools_admin_testButtonVerify_functionnal() throws InterruptedException, URISyntaxException, IOException {
		...
		while (System.currentTimeMillis() < end) {
			Thread.sleep(500);
			String result = selenium.getDriver().findElement(By.xpath("//*[@id='main_project_container']/div[1]")).getText();
		...
		String result2 = selenium.getDriver().findElement(By.xpath("//*[@id='main_project_container']/div[1]")).getText();
