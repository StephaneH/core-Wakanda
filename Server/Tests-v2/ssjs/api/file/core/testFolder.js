...
var testCase = {
    ...
    _should: {
        ignore: {
            testObjectFolderReadonlyAttributeValueTrue: true, // not implemented
            testObjectFolderVisibleAttributeValueFalse: true, // not implemented
            testObjectFolderCreateMethodReadonlyFolder: true, // not implemented
            testObjectFolderRemoveMethodErrorReadonly: true, // not implemented
            testObjectFolderDropMethodErrorReadonly: true, // not implemented
            testObjectFolderRemoveContentMethodErrorReadonly: true, // not implemented
            testObjectFolderDropContentMethodErrorReadonly: true, // not implemented
            testObjectFolderSetNameMethodFailsReadOnly: true // not implemented
        }
    },
    ...
    testObjectFolderFirstFolderAttributeValue: function () {
        ...
        if (os.isMac || os.isLinux) var folder = Folder(appPath + "Src/Folder/SubFolderToo");
    ...
    testObjectFolderFirstFolderAttributeIteration: function () {
        ...
        Y.Assert.areSame(2, result.length);
        if (os.isMac || os.isLinux) Y.Assert.areSame("SubFolderToo", result[0]);
        else Y.Assert.areSame("SubFolder", result[0]);
        if (os.isMac || os.isLinux) Y.Assert.areSame("SubFolder", result[1]);
    ...
    testObjectFolderFoldersAttributeValue: function () {
        ...
        if (os.isMac || os.isLinux) Y.Assert.areSame("SubFolderToo", obj.folders[0].name);
        else Y.Assert.areSame("SubFolder", obj.folders[0].name);
        Y.Assert.isObject(obj.folders[1]);
        if (os.isMac || os.isLinux) Y.Assert.areSame("SubFolder", obj.folders[1].name);
