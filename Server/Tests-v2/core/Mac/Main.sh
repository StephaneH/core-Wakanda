...
if more ${HomeDirectory}${Directory}global_log_${DATELOG}/tmpJSON_${DATELOG}/Rest/index.html | grep "true"
 then
...
for LT_STATIC in $(jot ${NUMBER_LOOP})
 do
...
if more ${HomeDirectory}${Directory}global_log_${DATELOG}/tmpJSON_${DATELOG}/RestSSL/index.html | grep "true"
 then
    echo "rest is enabled"
...
echo "Execute PHP Script : Log Parser"
