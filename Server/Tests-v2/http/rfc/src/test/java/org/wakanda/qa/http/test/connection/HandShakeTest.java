...
public class HandShakeTest extends AbstractHttpTestCase {
	...
	public void testThatServerDoesNotPerformRequestedMethodIfItReturnsFinalStatusCode()
		...
		if(getDefaultServer()==Server.APACHE) url = "/protected.html";
		...
		Header authResponse = authscheme.authenticate(creds, req);
	 ...
	 * <p/>
	 * <B>Reference:</b> SPEC693 (RFC1616 8.2.3) The test is ignored for now
	 * because the feature is expected in WAK3.
	 * <p/>
	 * 
	 * @throws Exception
	 */
