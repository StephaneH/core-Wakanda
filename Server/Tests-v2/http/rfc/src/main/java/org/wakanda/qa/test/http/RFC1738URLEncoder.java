 ...
 * 
 */
public class RFC1738URLEncoder {
	...
	static {
		safeCharacters = getDefaultSafeCharacters();
	}
	 ...
	 */
	public static String encodePath(String path, BitSet safeCharacters) {
	...
	public static String encodePath(String path){
		return encodePath(path, safeCharacters);
	}
