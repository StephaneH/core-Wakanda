...
import org.wakanda.qa.commons.server.settings.ISettings;
...
public class MediaTypeUtil{
	...
	private static ISettings settings = Configuration.getInstance().getSettings();
	...
	private String getMimeTypesXMLFilePath() throws IOException{
		...
		String wakSrvEVName = ((DefaultSettings)settings).getWakandaServerPathEVName();
