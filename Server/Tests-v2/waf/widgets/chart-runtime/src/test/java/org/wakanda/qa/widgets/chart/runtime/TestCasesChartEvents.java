...
public class TestCasesChartEvents extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException
	{
		...
		String solutionPath = getResourcePath(TestCasesChartEvents.class, Paths.solutionRelativePath);
	...
	//waitWebElementToBeClickable(selenium.getDriver(), By.id("richText1"), 5);
    }
    //------------------------------------------------------------------------
    // Desktop Events
    //------------------------------------------------------------------------
