...
public class TestCasesNavigationAPI extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetNavigationView/widgetNavigationView Solution/widgetNavigationView.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeNavigationview.class, Paths.solutionRelativePath);
