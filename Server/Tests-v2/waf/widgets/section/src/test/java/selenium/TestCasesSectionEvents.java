...
public class TestCasesSectionEvents extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetSection/widgetSection Solution/widgetSection.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeSection.class, Paths.solutionRelativePath);
