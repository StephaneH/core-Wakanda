...
public class TestCasesSelectAPI extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetSelect/widgetSelect Solution/widgetSelect.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeSelect.class, Paths.solutionRelativePath);
