...
public class ButtonEvents extends SeleniumRuntimeTemplate {
	...
	{
		Paths.solutionRelativePath = "/solutions/ButtonEvents/ButtonEvents Solution/ButtonEvents.waSolution";
		String solutionPath = getResourcePath(ButtonEvents.class, Paths.solutionRelativePath);
