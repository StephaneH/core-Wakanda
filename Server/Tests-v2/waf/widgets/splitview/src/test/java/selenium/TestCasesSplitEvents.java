...
public class TestCasesSplitEvents extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		Paths.solutionRelativePath = "/solutions/widgetSplitView/widgetSplitView Solution/widgetSplitView.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeSplitview.class, Paths.solutionRelativePath);
