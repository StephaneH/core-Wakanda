...
public class TestCasesPopoverAPI extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetPopover/widgetPopover Solution/widgetPopover.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimePopover.class, Paths.solutionRelativePath);
	...
	public void testPopover_disable() throws InterruptedException {
		...
		selenium.getJsConsole().executeScript("$('#textField1').select();");
		try {
			selenium.getDriver().findElement(By.id("textField1")).sendKeys("newValue");
			selenium.getDriver().findElement(By.id("textField1")).sendKeys(Keys.ENTER);
		} catch (Exception e) {}
		Thread.sleep(500);
