...
public class TestCasesImageAPI extends SeleniumRuntimeTemplate {
	@BeforeClass
	public static void beforeTestSuite() throws URISyntaxException, IOException{
		...
		String solutionPath = Common.getResourcePath(TestCasesImageAPI.class, Paths.solutionRelativePath);
