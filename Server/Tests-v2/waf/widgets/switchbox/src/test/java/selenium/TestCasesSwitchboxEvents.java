...
public class TestCasesSwitchboxEvents extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetSwitchbox/widgetSwitchbox Solution/widgetSwitchbox.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeSwitchbox.class, Paths.solutionRelativePath);
