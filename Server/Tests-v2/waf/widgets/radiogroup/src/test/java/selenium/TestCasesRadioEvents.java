...
public class TestCasesRadioEvents extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetRadioGroup/widgetRadioGroup Solution/widgetRadioGroup.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeRadiogroup.class, Paths.solutionRelativePath);
		Common.serverProcess = Common.startServer(solutionPath);
	}

	@Before
	public void before() {
		selenium.getDriver().get("http://127.0.0.1:8081/tablet/radioEvents.html");
	}
