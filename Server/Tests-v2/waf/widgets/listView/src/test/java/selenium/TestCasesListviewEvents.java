...
public class TestCasesListviewEvents extends SeleniumRuntimeTemplate {
	...
	public static void beforeRunning() throws URISyntaxException, IOException {
		...
		Paths.solutionRelativePath = "/solutions/widgetListview/widgetListview Solution/widgetListview.waSolution";
		String solutionPath = Common.getResourcePath(TestSuiteRuntimeListview.class, Paths.solutionRelativePath);
