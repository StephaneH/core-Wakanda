...
public class CalendarEvents extends SeleniumRuntimeTemplate{
	...
	{
		Paths.solutionRelativePath = "/solutions/CalendarEvents/CalendarEvents Solution/CalendarEvents.waSolution";
		String solutionPath = getResourcePath(CalendarEvents.class, Paths.solutionRelativePath);
