...
// eventHandlers// @lock
	...
	{// @endlock
		$$('richText1').setValue($$('image1').getValue());
	};// @lock

	setValue.click = function setValue_click (event)// @startlock
	{// @endlock
		$$('image1').setValue("./images/soleil.gif");
	};// @lock
	...
	{// @endlock
		var myPosition = $$('image1').getPosition();
	...
	{// @endlock
		$$('richText1').setValue($$('image1').getHeight());
	};// @lock

	getWidth.click = function getWidth_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('image1').getWidth());
	};// @lock
