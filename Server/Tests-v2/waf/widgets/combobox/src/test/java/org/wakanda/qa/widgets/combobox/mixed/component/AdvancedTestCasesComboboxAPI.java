...
public class AdvancedTestCasesComboboxAPI extends SeleniumRuntimeTemplate {

	@BeforeClass
	public static void beforeRunning() throws URISyntaxException, IOException
	{
		Paths.solutionRelativePath = "/solutions/widgetEvents/widgetEvents.waSolution";
		String solutionPath = getResourcePath(AdvancedTestCasesComboboxAPI.class, Paths.solutionRelativePath);
