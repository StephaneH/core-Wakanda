package org.wakanda.qa.widgets.combobox.mixed.component;
...
public class AdvanceTestCasesComboboxEvents extends SeleniumRuntimeTemplate {
    
	@BeforeClass
	public static void beforeRunning() throws URISyntaxException, IOException
	{
		Paths.solutionRelativePath = "/solutions/widgetEvents/widgetEvents.waSolution";
		String solutionPath = getResourcePath(AdvanceTestCasesComboboxEvents.class, Paths.solutionRelativePath);
