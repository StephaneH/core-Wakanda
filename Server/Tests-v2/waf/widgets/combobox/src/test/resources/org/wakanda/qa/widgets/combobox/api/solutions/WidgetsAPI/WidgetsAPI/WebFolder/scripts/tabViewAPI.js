...
// @region namespaceDeclaration// @startlock
	...
	var countTabs = {};	// @button
	var show = {};	// @button
	var hide = {};	// @button
	var getSelectedTab = {};	// @button
	var removeTab = {};	// @button
	var addTab_false = {};	// @button
	var addTab_true = {};	// @button
	var selectTab = {};	// @button
// @endregion// @endlock
...
// eventHandlers// @lock
	...
	{// @endlock
		var myPosition = $$('tabView1').getPosition();
	...
	{// @endlock
		$$('tabView1').resizable(true);
	};// @lock

	draggable.click = function draggable_click (event)// @startlock
	{// @endlock
		$$('tabView1').draggable(true);
	};// @lock

	countTabs.click = function countTabs_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('tabView1').countTabs());
	};// @lock
	...
	getSelectedTab.click = function getSelectedTab_click (event)// @startlock
	{// @endlock
		var tabObject = $$('tabView1').getSelectedTab();
	    $$('richText1').setValue(tabObject.index);
    	$$(tabObject.menuItem.id).renameMenuItem("My Tab");
    	$$(tabObject.container.id).setBackgroundColor("#9c0");
	};// @lock

	removeTab.click = function removeTab_click (event)// @startlock
	{// @endlock
		$$('tabView1').removeTab(1);
	};// @lock

	addTab_false.click = function addTab_false_click (event)// @startlock
	{// @endlock
		$$('tabView1').addTab("tab3", false);
	};// @lock

	addTab_true.click = function addTab_true_click (event)// @startlock
	{// @endlock
		$$('tabView1').addTab("tab3", true);
	};// @lock

	selectTab.click = function selectTab_click (event)// @startlock
	{// @endlock
...
// @region eventManager// @startlock
	...
	WAF.addListener("countTabs", "click", countTabs.click, "WAF");
	WAF.addListener("show", "click", show.click, "WAF");
	WAF.addListener("hide", "click", hide.click, "WAF");
	WAF.addListener("getSelectedTab", "click", getSelectedTab.click, "WAF");
	WAF.addListener("removeTab", "click", removeTab.click, "WAF");
	WAF.addListener("addTab_false", "click", addTab_false.click, "WAF");
	WAF.addListener("addTab_true", "click", addTab_true.click, "WAF");
	WAF.addListener("selectTab", "click", selectTab.click, "WAF");
// @endregion
};// @endlock
