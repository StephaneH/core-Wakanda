...
public class NominalTestCases extends TemplateChromeDebuggerTests {
	...
	public void currentBreakpointToggled() throws Exception, IOException {
		...
		String iconeDisplayed = getElementByXPath("//*[@id='scripts-editor-container-tabbed-pane']/div[2]/div/div/div[2]/div/div[2]/div").getCssValue("-webkit-border-image");
		...
		String currentIcone = getElementByXPath("//*[@id='scripts-editor-container-tabbed-pane']/div[2]/div/div/div[2]/div/div[2]/div").getCssValue("-webkit-border-image");
		assertEquals(currentIcone,"url(https://localhost:4433/walib/debugger/devtools/Images/"+iconeDisplayed+") 0 14 0 2 fill / 1 / 0px stretch") ; //petite icone rouge
	...
	public void currentLineActive() throws Exception, IOException {
		...
		String currentColor = getElementByXPath("//*[@id='scripts-editor-container-tabbed-pane']/div[2]/div/div/div[1]/div/div[2]").getCssValue("background-color");
	...
	public void breakpointsDisplayed() throws Exception, IOException {
		...
		String currentIcone = getElementByXPath("//*[@id='scripts-editor-container-tabbed-pane']/div[2]/div/div/div[2]/div/div[2]/div").getCssValue("-webkit-border-image");
		                                         //*[@id="scripts-editor-container-tabbed-pane"]/div[2]/div/div/div[2]/div/div[2]/div
		
		assertEquals(currentIcone,"url(https://localhost:4433/walib/debugger/devtools/Images/breakpointCounterBorder.png) 0 14 0 2 fill / 1 / 0px stretch") ; //petite icone rouge
	
	    currentIcone = getElementByXPath("//*[@id='scripts-editor-container-tabbed-pane']/div[2]/div/div/div[2]/div/div[3]/div").getCssValue("-webkit-border-image");
	                                      //*[@id="scripts-editor-container-tabbed-pane"]/div[2]/div/div/div[2]/div/div[3]/div
		
		assertEquals(currentIcone,"url(https://localhost:4433/walib/debugger/devtools/Images/breakpointBorder.png) 0 14 0 2 fill / 1 / 0px stretch") ;
