...
//		}
	...
	public void clickOnAbort() throws InterruptedException {
		...
		//selenium.getDriver().findElement(By.xpath("//*[@id='contexts_list']/div[3]/div[1]/a[2]")).click();
		//getElementByXPath(By.className("context cur_context expanded")).findElement(By.className("abort_button")).click();
		selenium.getDriver().findElement(By.xpath("//*[@class='context cur_context expanded']")).findElement(By.className("abort_button")).click();
		//getElementByXPath("//*[@id='contexts_list']").findElement(By.className("abort_button")).isEnabled()
		//*[@id="11"]/div[1]/a[2]
