...
public class WListViewWidgetTests extends SeleniumRuntimeTemplate {
	@BeforeClass
	public static void beforeRunning() throws URISyntaxException, IOException {
		//selenium.waitImplicitly(5);
startServer(WListViewWidgetTests.class, "/wListViewRuntime/wListViewRuntime Solution/wListViewRuntime.waSolution");
