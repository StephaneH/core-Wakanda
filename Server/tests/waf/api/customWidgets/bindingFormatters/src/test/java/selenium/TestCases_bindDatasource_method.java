...
public class TestCases_bindDatasource_method extends SeleniumRuntimeTemplate {
	@BeforeClass
	public static void beforeRunning() throws URISyntaxException, IOException
	{
		startServer(TestCases_bindDatasource_method.class, "/Untitled465/Untitled465 Solution/Untitled465.waSolution");
	} 
    ...
    @Test
    public void bindDatasource_without_argument() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource('dataClass1.name|lowercase')");
    ...
    @Test
    public void bindDatasource_with_argument_type_string() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|prefix 'mm' \")");
    ...
    @Test
    public void bindDatasource_with_argument_type_number() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|prefix 123 \")");
    ...
    @Test
    public void bindDatasource_with_argument_type_ds_expression() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|prefix dataClass1.ID \")");
    ...
    @Test
    public void bindDatasource_with_arguments_type_string() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|concat 'aa' 'bb' \")");
    ...
    @Test
    public void bindDatasource_with_arguments_type_number() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|concat 11 22 \")");
    ...
    @Test
    public void bindDatasource_with_arguments_type_ds_expression() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource('dataClass1.name|concat dataClass1.ID dataClass1.number')");
    ...
    @Test
    public void bindDatasource_with_argument_formater_type_string() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|lowercase|prefix 'bb'\")");
		String actualValue = (String) js.executeScript("return $$('test1').stringProp();");
    ...
    @Test
    public void bindDatasource_with_argument_formater_type_number() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|lowercase|prefix 123\")");
		String actualValue = (String) js.executeScript("return $$('test1').stringProp();");
    ...
    @Test
    public void bindDatasource_with_argument_formater_type_ds_expression() throws InterruptedException 
    {
    	launchHTMLPage("http://127.0.0.1:8081/index/");
		
		JavascriptExecutor js = (JavascriptExecutor) selenium.getDriver();
		js.executeScript("$$('test1').stringProp.bindDatasource(\"dataClass1.name|lowercase|prefix dataClass1.ID\")");
		String actualValue = (String) js.executeScript("return $$('test1').stringProp();");
