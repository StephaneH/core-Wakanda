...
public class TestCases_widgetInstanceApi extends SeleniumRuntimeTemplate {
	...
	{
		startServer(TestCases_widgetInstanceApi.class, "/CustomWidgetAPI/CustomWidgetAPI Solution/CustomWidgetAPI.waSolution");
		
	} 
  
    @Before
    public void beforeTest(){
		selenium.getDriver().get("http://127.0.0.1:8084/");
