...
// eventHandlers
	...
	propertyName.click = function propertyName_click (event)
	{
...
//	testProperty.onModify(modifyFunction);
	...
	removeAll.click = function removeAll_click (event)
	{
	...
	insert.click = function insert_click (event)
	{
	...
	concat.click = function concat_click (event)
	{
	...
	move.click = function move_click (event)
	{
		var property = $$('test1').test;
		var elem = property()[0];
		property.move(0,2);
	...
	push.click = function push_click (event)
	{
	...
	pop.click = function pop_click (event)
	{
	...
	shift.click = function shift_click (event)
	{
	...
	remove.click = function remove_click (event)
	{
		var count = 5;
		var i = Math.floor((Math.random()*count));
