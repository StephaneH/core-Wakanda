...
// @region namespaceDeclaration// @startlock
	...
	var setValue_false = {};	// @button
	var setValue_true = {};	// @button
	var getValue = {};	// @button
	var toggleCheckbox = {};	// @button
	var uncheck = {};	// @button
	var check = {};	// @button
// @endregion// @endlock
...
// eventHandlers// @lock
	...
	{// @endlock
		var myPosition = $$('checkbox1').getPosition();
	...
	setValue_false.click = function setValue_false_click (event)// @startlock
	{// @endlock
		$$('checkbox1').setValue(false);
	};// @lock

	setValue_true.click = function setValue_true_click (event)// @startlock
	{// @endlock
	...
	{// @endlock
		$$('richText1').setValue($$('checkbox1').getValue().toString());
	};// @lock

	toggleCheckbox.click = function toggleCheckbox_click (event)// @startlock
	{// @endlock
		$$('checkbox1').toggleCheckbox();
	};// @lock

	uncheck.click = function uncheck_click (event)// @startlock
	{// @endlock
		$$('checkbox1').uncheck();
	};// @lock
...
// @region eventManager// @startlock
	...
	WAF.addListener("setValue_false", "click", setValue_false.click, "WAF");
	WAF.addListener("setValue_true", "click", setValue_true.click, "WAF");
	WAF.addListener("getValue", "click", getValue.click, "WAF");
	WAF.addListener("toggleCheckbox", "click", toggleCheckbox.click, "WAF");
	WAF.addListener("uncheck", "click", uncheck.click, "WAF");
