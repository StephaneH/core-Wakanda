...
public class ImageEvents extends SeleniumRuntimeTemplate{
	...
	public static void beforeTestSuite() throws URISyntaxException, IOException{
		Paths.solutionRelativePath = "/solutions/ImageTest/ImageTest Solution/ImageTest.waSolution";
		AdminCommand.startServer(ImageEvents.class, Paths.solutionRelativePath);
