...
public class AdvancedTestCasesAutoformAPI extends SeleniumRuntimeTemplate {
    
    @BeforeClass
    public static void beforeTestSuite() throws URISyntaxException, IOException{
	startServer(AdvancedTestCasesAutoformAPI.class, "/solutions/mixedwidgetsAPI/mixedwidgetsAPI Solution/mixedwidgetsAPI.waSolution");
    }
    //------------------------------------------------------------------------
    // Specific API 
    //------------------------------------------------------------------------
