...
public class AdvancedTestCasesGridAPI extends SeleniumRuntimeTemplate {
    
	@BeforeClass
	public static void beforeRunning() throws URISyntaxException, IOException
	{
		Paths.solutionRelativePath = "/solutions/widgetAPI/widgetAPI.waSolution";
		String solutionPath = getResourcePath(AdvancedTestCasesGridAPI.class, Paths.solutionRelativePath);
