...
public class AdvancedTestCasesContainerEvents extends SeleniumRuntimeTemplate {
	
	@BeforeClass
	public static void beforeTestSuite() throws URISyntaxException, IOException{
		startServer(AdvancedTestCasesContainerEvents.class, "/solutions/mixedwidgetEvents/mixedwidgetEvents Solution/mixedwidgetEvents.waSolution");
	}
    ...
    public void beforeTest(){
		...
		selenium.waitWebElementToBeClickable(selenium.getDriver(), By.id("waf-body"), 8);
    }
    //------------------------------------------------------------------------
    // Desktop Events
    //------------------------------------------------------------------------
