...
// @region namespaceDeclaration// @startlock
	...
	var toggleSplitter = {};	// @button
	var expandSplitter = {};	// @button
	var collapseSplitter = {};	// @button
	var setSplitPosition = {};	// @button
	var getSplitPosition = {};	// @button
// @endregion// @endlock
...
// eventHandlers// @lock
	...
	{// @endlock
		$$('container1').setLabelTextColor("#650092");
	};// @lock

	setLabelText.click = function setLabelText_click (event)// @startlock
	{// @endlock
		$$('container1').setLabelText("toto");
	};// @lock
	...
	{// @endlock
		var myPosition = $$('container1').getPosition();
	...
	{// @endlock
		$$('container1').removeClass("toto");
	};// @lock

	addClass.click = function addClass_click (event)// @startlock
	{// @endlock
		$$('container1').addClass("toto");
	};// @lock

	show.click = function show_click (event)// @startlock
	{// @endlock
		$$('container1').show(true);
	};// @lock

	hide.click = function hide_click (event)// @startlock
	{// @endlock
		$$('container1').hide(true);
	};// @lock

	resizable.click = function resizable_click (event)// @startlock
	{// @endlock
		$$('container1').resizable(true);
	};// @lock

	draggable.click = function draggable_click (event)// @startlock
	{// @endlock
		$$('container1').draggable(true);
	};// @lock

	toggleSplitter.click = function toggleSplitter_click (event)// @startlock
	{// @endlock
		$$('container1').toggleSplitter();
	};// @lock

	expandSplitter.click = function expandSplitter_click (event)// @startlock
	{// @endlock
		$$('container1').expandSplitter();
	};// @lock

	collapseSplitter.click = function collapseSplitter_click (event)// @startlock
	{// @endlock
		$$('container1').collapseSplitter();
	};// @lock

	setSplitPosition.click = function setSplitPosition_click (event)// @startlock
	{// @endlock
		$$('container1').setSplitPosition(50);
	};// @lock

	getSplitPosition.click = function getSplitPosition_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('container1').getSplitPosition());
	};// @lock
...
// @region eventManager// @startlock
	...
	WAF.addListener("toggleSplitter", "click", toggleSplitter.click, "WAF");
	WAF.addListener("expandSplitter", "click", expandSplitter.click, "WAF");
	WAF.addListener("collapseSplitter", "click", collapseSplitter.click, "WAF");
	WAF.addListener("setSplitPosition", "click", setSplitPosition.click, "WAF");
	WAF.addListener("getSplitPosition", "click", getSplitPosition.click, "WAF");
// @endregion
};// @endlock
