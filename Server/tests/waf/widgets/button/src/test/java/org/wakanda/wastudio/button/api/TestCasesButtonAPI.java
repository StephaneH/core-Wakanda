...
public class TestCasesButtonAPI extends SeleniumRuntimeTemplate {
	@BeforeClass
	 public static void beforeTestSuite() throws URISyntaxException, IOException{
		AdminCommand.startServer(TestCasesButtonAPI.class, "/solutions/WidgetsAPI/WidgetsAPI.waSolution");
	 }
        
    @Before
    public void beforeTest(){
	logger.info("Opening main page in localhost");
	selenium.getDriver().get("http://127.0.0.1:8081/buttonAPI.html");
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getCssValue("display");
	...
	boolean myResult = selenium.getDriver().findElement(By.id("button1")).getAttribute("className").contains("toto");
	...
	WebElement myElement = selenium.getDriver().findElement(By.id("button1"));
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getAttribute("offsetWidth");
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getAttribute("offsetHeight");
	assertEquals("100", myResult);
    }
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getAttribute("offsetLeft");
	assertEquals("100", myResult);
    }
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getCssValue("right");
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getAttribute("offsetTop");
	assertEquals("100", myResult);
    }
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getCssValue("bottom");
	assertEquals("100px", myResult);
    }
	...
	Boolean myResult = selenium.getDriver().findElement(By.id("button1")).getAttribute("innerHTML").contains("undefined");
	assertEquals(false, myResult);
    }
    ...
    */
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getCssValue("background-color").replaceAll("\\s","");
	...
	String myResult = selenium.getDriver().findElement(By.id("button1")).getCssValue("color").replaceAll("\\s","");
	assertEquals("rgba(101,0,146,1)", myResult);
    }
	...
	selenium.getDriver().findElement(By.id("richText1")).findElement(By.id("button1"));
    }
