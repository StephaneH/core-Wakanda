...
// @region namespaceDeclaration// @startlock
	...
	var goToPreviousPage = {};	// @button
	var goToNextPage = {};	// @button
	var goToLast = {};	// @button
	var goToFirst = {};	// @button
	var goTo = {};	// @button
	var getTotalPages = {};	// @button
	var getDisplayedRow = {};	// @button
	var getCurrentPage = {};	// @button
// @endregion// @endlock
...
// eventHandlers// @lock
	...
	{// @endlock
		var myPosition = $$('matrix1').getPosition();
	...
	{// @endlock
		$$('matrix1').resizable(true);
	};// @lock

	draggable.click = function draggable_click (event)// @startlock
	{// @endlock
		$$('matrix1').draggable(true);
	};// @lock

	goToPreviousPage.click = function goToPreviousPage_click (event)// @startlock
	{// @endlock
		$$('matrix1').goToPreviousPage();
	};// @lock

	goToNextPage.click = function goToNextPage_click (event)// @startlock
	{// @endlock
		$$('matrix1').goToNextPage();
	};// @lock

	goToLast.click = function goToLast_click (event)// @startlock
	{// @endlock
		$$('matrix1').goToLast();
	};// @lock

	goToFirst.click = function goToFirst_click (event)// @startlock
	{// @endlock
		$$('matrix1').goToFirst();
	};// @lock

	goTo.click = function goTo_click (event)// @startlock
	{// @endlock
		$$('matrix1').goTo(2);
	};// @lock

	getTotalPages.click = function getTotalPages_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('matrix1').getTotalPages());
	};// @lock

	getDisplayedRow.click = function getDisplayedRow_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('matrix1').getDisplayedRow());
	};// @lock

	getCurrentPage.click = function getCurrentPage_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('matrix1').getCurrentPage());
	};// @lock
...
// @region eventManager// @startlock
	...
	WAF.addListener("goToPreviousPage", "click", goToPreviousPage.click, "WAF");
	WAF.addListener("goToNextPage", "click", goToNextPage.click, "WAF");
	WAF.addListener("goToLast", "click", goToLast.click, "WAF");
	WAF.addListener("goToFirst", "click", goToFirst.click, "WAF");
	WAF.addListener("goTo", "click", goTo.click, "WAF");
	WAF.addListener("getTotalPages", "click", getTotalPages.click, "WAF");
	WAF.addListener("getDisplayedRow", "click", getDisplayedRow.click, "WAF");
	WAF.addListener("getCurrentPage", "click", getCurrentPage.click, "WAF");
// @endregion
};// @endlock
