...
// eventHandlers// @lock
	...
	{// @endlock
		$$('richText1').setValue($$('radioGroup1').getValue());
	};// @lock
	...
	{// @endlock
		$$('radioGroup1').setLabelTextColor("#650092");
	};// @lock

	setLabelText.click = function setLabelText_click (event)// @startlock
	{// @endlock
		$$('radioGroup1').setLabelText("toto");
	};// @lock
	...
	{// @endlock
		var myPosition = $$('radioGroup1').getPosition();
