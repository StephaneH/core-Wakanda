...
"adminLogic" : 
	[
		/*[0]*/
		{"case" : 0, "ae":{"arg" : "--admin-passwordvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 1, "ae":{"arg" : "/admin-passwordvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 2, "ae":{"arg" : "--admin-portvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 3, "ae":{"arg" : "/admin-portvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 4, "ae":{"arg" : "--admin-ssl-portvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 5, "ae":{"arg" : "/admin-ssl-portvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 6, "ae":{"arg" : "--admin-publishvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 7, "ae":{"arg" : "/admin-publishvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null}
	]
};	
...
for (var hl = 0; hl < adminLogicCase.adminLogic.length; hl++) 
	{
		testCase["testCLIargs_helpOptionLogic_" + adminLogicCase.adminLogic[hl].case + "_" + argformat(adminLogicCase.adminLogic[hl].ae.arg)] = function() 
		{
			var phl0 = adminLogicCase.adminLogic[index];
			var phl1 = adminLogicCase.name;
			var phl2 = adminLogicCase.args;
			var phl3 = argformat(adminLogicCase.adminLogic[index].ae.arg); 
