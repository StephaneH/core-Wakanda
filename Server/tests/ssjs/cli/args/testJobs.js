...
"jobLogic" : 
	[
		/*[0]*/
		{"case" : 0, "ae":{"arg" : "-job-id", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 1, "ae":{"arg" : "--job-idvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 2, "ae":{"arg" : "-job-id value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 3, "ae":{"arg" : "/job-id", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 4, "ae":{"arg" : "/job-idvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null}
	]
};
...
for (var hl = 0; hl < jobLogicCase.jobLogic.length; hl++) 
	{
		testCase["testCLIargs_helpOptionLogic_" + jobLogicCase.jobLogic[hl].case + "_" + argformat(jobLogicCase.jobLogic[hl].ae.arg)] = function() 
		{
			var phl0 = jobLogicCase.jobLogic[index];
			var phl1 = jobLogicCase.name;
			var phl2 = jobLogicCase.args;
			var phl3 = argformat(jobLogicCase.jobLogic[index].ae.arg); 
