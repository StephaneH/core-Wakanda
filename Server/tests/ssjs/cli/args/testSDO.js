...
"sdoLogic" : 
	[
		/*[0]*/
		{"case" : 0, "ae":{"arg" : "--no-discovery value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 1, "ae":{"arg" : "/no-discovery value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 2, "ae":{"arg" : "--NO-DISCOVERY", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 3, "ae":{"arg" : "/NO-DISCOVERY", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null}
	]
};
...
for (var hl = 0; hl < sdoLogicCase.sdoLogic.length; hl++) 
	{
		testCase["testCLIargs_helpOptionLogic_" + sdoLogicCase.sdoLogic[hl].case + "_" + argformat(sdoLogicCase.sdoLogic[hl].ae.arg)] = function() 
		{
			var phl0 = sdoLogicCase.sdoLogic[index];
			var phl1 = sdoLogicCase.name;
			var phl2 = sdoLogicCase.args;
			var phl3 = argformat(sdoLogicCase.sdoLogic[index].ae.arg); 
