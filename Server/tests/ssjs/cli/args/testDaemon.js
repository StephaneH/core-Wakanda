...
{
"args" : "daemon", 
"name" : "daemonTestLogic",
"daemonLogic" : 
	[
		/*[0]*/
		{"case" : 0, "ae":{"arg" : "-d value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 1, "ae":{"arg" : "/d value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 2, "ae":{"arg" : "-dvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 3, "ae":{"arg" : "/dvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 4, "ae":{"arg" : "/D VALUE", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 5, "ae":{"arg" : "-D VALUE", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 6, "ae":{"arg" : "-DVALUE", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 7, "ae":{"arg" : "/DVALUE", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 8, "ae":{"arg" : "/daemon value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 9, "ae":{"arg" : "--daemon value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 10, "ae":{"arg" : "/daemonvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 11, "ae":{"arg" : "--daemonvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 12, "ae":{"arg" : "/DAEMON value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 13, "ae":{"arg" : "--DAEMON value", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 14, "ae":{"arg" : "/DAEMONvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null},
		{"case" : 15, "ae":{"arg" : "--DAEMONvalue", "expected":{"win":false,"linux":false,"mac":false}}, "config" : null, "out" : null, "in" : null}
...
/* Generated tests for Logic optionDaemon */

//Attention, different scope for() and function()
for (var hl = 0; hl < daemonLogicCase.daemonLogic.length; hl++) 
	{
		testCase["testCLIargs_helpOptionLogic_" + daemonLogicCase.daemonLogic[hl].case + "_" + argformat(daemonLogicCase.daemonLogic[hl].ae.arg)] = function() 
		{
			var phl0 = daemonLogicCase.daemonLogic[index];
			var phl1 = daemonLogicCase.name;
			var phl2 = daemonLogicCase.args;
			var phl3 = argformat(daemonLogicCase.daemonLogic[index].ae.arg); 
			var phl4 = daemonLogicCase.daemonLogic[index].config; 
