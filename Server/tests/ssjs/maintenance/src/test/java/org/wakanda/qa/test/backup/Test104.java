...
public class Test104 {
	...
	@Test
	public void testBackupDS_DestinationAndUseUniqueNames_areFilesCreated_firstBackup()
	...
	@Test
	public void testBackupDS_DestinationAndUseUniqueNames_areFilesCreated_secondBackup()
			throws IOException, URISyntaxException {
		// Dans ce test, on vérifie just qu'un nouveau dossier est créé dans le
		// dossier "Backups"
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_DestinationAndUseUniqueNames_returns() throws IOException,
			URISyntaxException {
