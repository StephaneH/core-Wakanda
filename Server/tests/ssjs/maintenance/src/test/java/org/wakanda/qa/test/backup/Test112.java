...
public class Test112 {
	...
	@Test
	public void test1BackupDS_UseUniqueNamesAndBRF_areFilesCreated_firstBackup()
	...
	@Test
	public void test2BackupDS_UseUniqueNamesAndBRF_areFilesCreated_firstBackup()
			throws IOException, URISyntaxException {
		// Dans ce test, on vérifie just qu'un nouveau dossier est créé dans le
		// dossier "Backups"
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void test1BackupDS_UseUniqueNamesAndBRF_areFilesCreated_secondBackup()
			throws IOException, URISyntaxException {
		// Dans ce test, on vérifie just qu'un nouveau dossier est créé dans le
		// dossier "Backups"
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void test2BackupDS_UseUniqueNamesAndBRF_areFilesCreated_secondBackup()
			throws IOException, URISyntaxException {
		// Dans ce test, on vérifie just qu'un nouveau dossier est créé dans le
		// dossier "Backups"
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_UseUniqueNamesAndBRF_returns() throws IOException,
			URISyntaxException {
