...
public class Test106 extends TemplateTestClass {
	...
	@Test
	public void testBackupDS_FullSettings_areFilesCreated_secondBackup()
			throws IOException, URISyntaxException {
		// Dans ce test, on vérifie just qu'un nouveau dossier est créé dans le
		// dossier "Backups"
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_isCorrecteName() throws IOException,
			URISyntaxException {
		...
		File backupFolder = Utils.getBackupFolder(
				Utils.getBackupFolder("backup1"), "MyBackups");
		File[] backups = backupFolder.listFiles();
		String name_Backup = backups[backups.length - 2].getName();
	...
	@Test
	public void testBackupDS_FullSettings_BackupContentNames()
			throws IOException, URISyntaxException {
	...
	@Test
	public void testBackupDS_FullSettings_DataFolderContentNames()
			throws IOException, URISyntaxException {
	...
	@Test
	public void testBackupDS_FullSettings_returns_type() throws IOException,
			URISyntaxException {
	...
	@Test
	public void testBackupDS_FullSettings_returns_name() throws IOException,
			URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// name
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_nameNoExt()
			throws IOException, URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// nameNoExt
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_extension()
			throws IOException, URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// extension
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_path() throws IOException,
			URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// path
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
		...
		String pathValue = Utils.getPathValue(
				Utils.getSolutionPath("solution2"), "MyBackups");
	...
	@Test
	public void testBackupDS_FullSettings_returns_exists() throws IOException,
			URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// exists
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_visible() throws IOException,
			URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// visible
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_readOnly()
			throws IOException, URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// readOnly
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_creationDate()
			throws IOException, URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// creationDate
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
	...
	@Test
	public void testBackupDS_FullSettings_returns_lastModifiedDate()
			throws IOException, URISyntaxException {
		// Dans ce test on vérifie le retour de la fonction backupDataStore:
		// lastModifiedDate
		Utils.ChangeBootstrap(Utils.getSolutionPath("solution1"),
