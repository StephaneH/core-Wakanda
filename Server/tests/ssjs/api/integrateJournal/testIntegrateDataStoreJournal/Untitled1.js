 ...
 * create a project/solution with a simple data class in the model, and enable journaling
 * create a javascript code that will create 5 records and then perform a backup
 * launch the solution and run the previous code a number of times.
 * In the Backups folder you will find the snapshots
 * Starting from the second backup, and in increasing order of time stamp:
 ...
 * when you're done, copy your projects model.waModel into 'Assets' and name it testMode.waModel
 
 Limitation: The test cannot actually verify the correct number of records have been integrated because 
 ...
 */
	...
	//Integrates journal N in data file N fails
