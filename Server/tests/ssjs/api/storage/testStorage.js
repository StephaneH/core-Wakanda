...
var e,
    error = 0,
    objectStorage = {"test0":'result0'},
    StorageObject,
    arrayStorage = ["test0","test1","test2"], 
    StorageArray,
    array2DStorage = ["test0",["test_0"],"test1"],
    StorageArray2D,
    stringStorage = "Lorem ipsum dolor sit amet, consectetur adipiscing elit." +
    ...
    nullStorage = null,
    StorageNull,
    undefinedStorage = undefined,
    StorageUndefined,
    NaNStorage = 1 / undefined,
    StorageNaN,
    infinityStorage = Infinity,
    StorageInfinity,
    blobStorage = new Blob(20, 88, "application/octet-stream"),
    StorageBlob,
    BlobStorageToString = blobStorage.toString(),
    StorageBlobToString,
    BlobStorageToBuffer = blobStorage.toBuffer(),
    StorageBlobToBuffer, 
    bufferStorage = new Buffer(16*1024),
    StorageBuffer;
...
var testCase = {
  ...
  // 9 --**-- Object storage.unlock() exist
   ...
   testStorage_StorageObjectContainTest0_12: function() {
  ...
  // 53 --**-- Storage a null 
   ...
   storage.StorageString = stringStorage;
   var getItemString = storage.getItem('StorageString');
       getItemString = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
        "Curabitur volutpat enim nec orci rhoncus id fringilla arcu lacinia." +
        "Integer nec purus eu est rutrum pharetra non non nulla." + 
        "Curabitur volutpat enim nec orci rhoncus id fringilla arcu lacinia." +
    ...
    var getNewItemString = storage.getItem('StorageString');
       result = getItemString;
   Y.Assert.areEqual("Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
        "Curabitur volutpat enim nec orci rhoncus id fringilla arcu lacinia." +
        "Integer nec purus eu est rutrum pharetra non non nulla." + 
        "Curabitur volutpat enim nec orci rhoncus id fringilla arcu lacinia." +
   ...
   testStorage_removeItemArray2D_75: function() {
