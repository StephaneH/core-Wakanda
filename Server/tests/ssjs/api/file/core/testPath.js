...
var testCase = {
    ...
    _should: {
        ignore: {
            testBackslashCombinations: true,
            testSingleDotCombinations: true,
            testDoubleDotCombinations: true,
            testSingleAndDoubleDotCombinations: true,
            testOverallCombinations: true
        }
    },
    ...
    setUp : function () {
        ...
        if (!os.isWindows) {
            ...
            this._should.ignore.testSingleDotCombinations = true;
            this._should.ignore.testDoubleDotCombinations = true;
            this._should.ignore.testSingleAndDoubleDotCombinations = true;
            this._should.ignore.testOverallCombinations = true;
        }
        */
    },
