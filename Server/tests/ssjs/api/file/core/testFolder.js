...
if (os.isLinux && typeof envVars.IS_32 !== "undefined") {
    IS_Linux32 = (envVars.IS_32 === true || envVars.IS_32 === 'true');
}
...
var testCase = {
    ...
    _should: {
        ignore: {
            ...
            testObjectFolderReadonlyAttributeValueFalse: true,
            testObjectFolderVisibleAttributeValueTrue: true,
            testObjectFolderVisibleAttributeValueFalse: true,
            testObjectFolderCreateMethodReadonlyFolder: true,
            testObjectFolderDropMethodExists: true,
            testObjectFolderDropMethodErrorNonExisting: true,
            testObjectFolderDropMethodErrorReadonly: true,
            testObjectFolderDropMethodOnFolder: true,
            testObjectFolderDropMethodOnFolderWithSubFolders: true,
            testObjectFolderDropContentMethodExists: true,
            testObjectFolderDropContentMethodErrorNonExisting: true,
            testObjectFolderDropContentMethodErrorReadonly: true,
            testObjectFolderDropContentMethodOnFolder: true,
    ...
    testObjectFolderFilesAttributeValue: function () {
        ...
        if (os.isMac || IS_Linux32) Y.Assert.areSame("second_file_empty", obj.files[0].name);
        else Y.Assert.areSame("file_empty", obj.files[0].name);
        Y.Assert.isObject(obj.files[1]);
        if (os.isMac || IS_Linux32) Y.Assert.areSame("file_empty", obj.files[1].name);
    ...
    testObjectFolderFirstFileAttributeValue: function () {
        ...
        if (os.isMac || IS_Linux32) var file = File(appPath + "Src/Folder/second_file_empty");
    ...
    testObjectFolderFirstFileAttributeIteration: function () {
        ...
        if (os.isMac || IS_Linux32) Y.Assert.areSame("second_file_empty", result[0]);
        else Y.Assert.areSame("file_empty", result[0]);
        if (os.isMac || IS_Linux32) Y.Assert.areSame("file_empty", result[1]);
    ...
    testObjectFolderFirstFolderAttributeValue: function () {
        ...
        if (os.isMac || (os.isLinux && IS_Linux32 === false)) var folder = Folder(appPath + "Src/Folder/SubFolderToo");
    ...
    testObjectFolderFirstFolderAttributeIteration: function () {
        ...
        Y.Assert.areSame(2, result.length);
        if (os.isMac || (os.isLinux && IS_Linux32 === false)) Y.Assert.areSame("SubFolderToo", result[0]);
        else Y.Assert.areSame("SubFolder", result[0]);
        if (os.isMac || (os.isLinux && IS_Linux32 === false)) Y.Assert.areSame("SubFolder", result[1]);
    ...
    testObjectFolderFoldersAttributeValue: function () {
        ...
        if (os.isMac || (os.isLinux && IS_Linux32 === false)) Y.Assert.areSame("SubFolderToo", obj.folders[0].name);
        else Y.Assert.areSame("SubFolder", obj.folders[0].name);
        Y.Assert.isObject(obj.folders[1]);
        if (os.isMac || (os.isLinux && IS_Linux32 === false)) Y.Assert.areSame("SubFolder", obj.folders[1].name);
