...
*/
    ...
    var testCase = {
    	...
    	_getMimeMessagePart: function(type){
    		...
    		var photo = loadImage((getFolder("path")+"logo.jpg").toString());
    		mimeWriter.addPart ("this is just a plain text", "TXT00", 'text/plain');
			mimeWriter.addPart (photo, "IMG00", 'image/jpg');
    ...
    */
    testThatMediaTypeAttributeReturnsTheRightValue: function() {
		...
		Y.Assert.areSame("image/jpg",mediaTypeImage);
    ...
    */
		...
		var photoExpectedSize = loadImage((getFolder("path")+"logo.jpg").toString()).size;
