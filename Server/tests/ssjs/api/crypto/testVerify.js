...
var testCase = {
	...
	testVerify_04_checkSignature: function() {
		
		var myTextFile = File ("/PROJECT/MyText.txt");
		...
		var myCertFile = File ("/PROJECT/MyCert.pem");
		var myCert = myCertFile.toString();

		var mySignedDigestFile = File ("/PROJECT/MySignedDigest");
