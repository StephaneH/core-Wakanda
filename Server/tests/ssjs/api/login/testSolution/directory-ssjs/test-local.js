...
var testCase = {
    ...
    /**
     * DRSS-4 Check that currentUser method returns the default user if session is invalid.
     */
     ...
     */
    testCurrentSessionMethodReturnsValidSessionObjectWhenSessionIsValid: function() {
        this._assertIsDefaultUser();
        var loggedin = application.loginByPassword("default", "password");
        Y.Assert.isTrue(loggedin);
        var cs = application.currentSession();
