var testCase = {
	...
	testTransitiveRelationAccess:function(){
		...
		if(rel_1_start.Link_10.Link_11.ID != rel_1_end.ID)
	...
	testTernaryRelationAccess:function(){
		var film_1 = new ds.Film();
		film_1.ID = 1;  //le bug WAK0083603 nous oblige de faire cette affectation
		film_1.save();

		var seance_1 = new ds.Seance();
		seance_1.ID = 1;  //le bug WAK0083603 nous oblige de faire cette affectation
		seance_1.save();

		var salle_1 = new ds.Salle();
		salle_1.ID = 1;  //le bug WAK0083603 nous oblige de faire cette affectation
		salle_1.save();

		var projection_1 = new ds.Projection();
		projection_1.Link_12 = seance_1;
		projection_1.Link_13 = film_1;
		projection_1.Link_14 = salle_1;
		projection_1.save();
