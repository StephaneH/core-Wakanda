...
var testCase = {
    ...
    // 1 --**-- Port property exist 
    testHTTPServerSSL_PortPropertyExist_1: function() {   
    
    Y.Assert.isNumber(httpServer.ssl.port);
    
      },

    // 2 --**-- GetCertificationPath() method exist
    testHTTPServerSSL_GetCertificationPathMethodExist_2: function() {   
