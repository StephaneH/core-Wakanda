...
function generateJSON()
{
	...
	for (var jpg2000Case = 0; jpg2000Case < jpg2000Resolution.length;jpg2000Case++)
	{
			...
			jsonResult.jpg2000Logic.push(
				{
					...
					"jpg2000Case":
					{
						"file" : jpg2000Resolution[jpg2000Case] + ".jpf",
						"config" : jpg2000Logic[configCase],
						"resolution" : jpg2000Resolution[jpg2000Case]
					}
				}
			);
		};
...
var JPEG2000LogicCase = generateJSON();
...
console.log("No config to test for JPEG2000");
...
var testCase = 
{
	...
	/*
	 *
	 * Test methods for API SSJS IMAGE JPEG2000
	 *
	 */
};

//Attention, different scope for() and function()
for (var jpg2000 = 0; jpg2000 < JPEG2000LogicCase.jpg2000Logic.length; jpg2000++)
{
	testCase["testImage_" + JPEG2000LogicCase.jpg2000Logic[jpg2000].case + "_" + jpg2000 + JPEG2000LogicCase.jpg2000Logic[jpg2000].jpg2000Case.config + "_" + JPEG2000LogicCase.jpg2000Logic[jpg2000].jpg2000Case.file + "_" + "JPEG2000"] = function()
	{
		var pjpg2000 = JPEG2000LogicCase.jpg2000Logic[index].jpg2000Case.file;
		var pjpg20001 = JPEG2000LogicCase.jpg2000Logic[index].jpg2000Case.config;
		var pjpg20002 = JPEG2000LogicCase.jpg2000Logic[index].jpg2000Case.resolution;

		console.log("JPEG2000 File " + pjpg2000);
		console.log("JPEG2000 Config " + pjpg20001);
		console.log("JPEG2000 Resolution " + pjpg20002);

		generator(pjpg2000,pjpg20001);
	};
};
