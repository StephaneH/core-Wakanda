...
function generateJSON()
{
	...
	for (var tifCase = 0; tifCase < tifResolution.length;tifCase++)
	{
				...
				jsonResult.tifLogic.push(
					{
						...
						"tifCase":
						{
							"file" : tifResolution[tifCase] + "_" + tiffOption[optionCase] + ".tif",
							"config" : tifLogic[configCase],
							"resolution" : tifResolution[tifCase]
						}
					}
				);
			};	
