...
var testCase = 
{
	...
	/*
	 *
	 * Test methods for API SSJS IMAGE JPG
	 *
	 */
};
...
{
	testCase["testImage_" + JPGLogicCase.jpgLogic[jpg].case + "_" + JPGLogicCase.jpgLogic[jpg].jpgCase.config + "_" + JPGLogicCase.jpgLogic[jpg].jpgCase.file + "_" + "JPG"] = function()
	{
		var pjpg = JPGLogicCase.jpgLogic[index].jpgCase.file;
		var pjpg1 = JPGLogicCase.jpgLogic[index].jpgCase.config;
		var pjpg2 = JPGLogicCase.jpgLogic[index].jpgCase.resolution;
		var pjpg3 = JPGLogicCase.jpgLogic[index].jpgCase.width;
		var pjpg4 = JPGLogicCase.jpgLogic[index].jpgCase.height;

		console.log("JPG File " + pjpg);
		console.log("JPG Config " + pjpg1);
		console.log("JPG Resolution " + pjpg2);
		console.log("JPG width " + pjpg3);
		console.log("JPG height " + pjpg4);

		generator(pjpg,pjpg1,pjpg3,pjpg4);
	};
};
