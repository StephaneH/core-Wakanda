...
var testCase = {
    ...
    _should: {
        ignore: {
			...
			testOnSet_Time:true,
			testOnSet_Real:true,
			testOnSort_Text:true,
			testOnSort_Time:true,
			testOnSort_Real:true,
			testOnQuery_Text:true,
			testOnQuery_Time:true,
			testOnQuery_Real:true
		}
    },
	setUp : function () {
		if (os.isWindows) {
