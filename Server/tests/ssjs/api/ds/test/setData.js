...
y.mother = v;
y.save();
var ab = new ds.People();
ab.name = "AB";
ab.sexe = "F";
ab.father = j;
ab.mother = v;
ab.save();
var mn = new ds.People();
mn.name = "MN";
mn.sexe = "M";
mn.father = u;
mn.mother = x;
mn.save();
var rs = new ds.People();
rs.name = "RS";
rs.sexe = "F";
rs.father = u;
rs.mother = x;
rs.save();
var momo = new ds.People();
momo.name = "MOMO";
momo.sexe = "M";
momo.father = mn;
momo.mother = ab;
momo.save();
var toto = new ds.People();
toto.name = "TOTO";
toto.sexe = "F";
toto.father = mn;
toto.mother = ab;
...
var firstmother = ds.People.find("ID = 1");
var secondfather = new ds.People();
secondfather.name = "PL";
secondfather.sexe = "M";
secondfather.save();
var otherChild = new ds.People();
otherChild.name = "newChild";
otherChild.sexe = "M";
otherChild.mother = firstmother;
otherChild.father = secondfather;
otherChild.save();
...
// Company4
var comp1 = new ds.Company4();
comp1.name = "4D";
comp1.save();

var comp2 = new ds.Company4();
comp2.name = "Google";
comp2.save();
...
// Employee4
var manager1 = new ds.Employee4();
manager1.name = "manager1";
manager1.age = 33;
manager1.salary = 3000;
manager1.isManager = true;
manager1.employer = comp1;
manager1.save();

var manager2 = new ds.Employee4();
manager2.name = "manager2";
manager2.age = 30;
manager2.salary = 2500;
manager2.isManager = true;
manager2.employer = comp1;
manager2.save();


var emp1 = new ds.Employee4();
emp1.name = "name1";
emp1.age = 25;
emp1.salary = 1000;
emp1.isManager = false;
emp1.manager = manager1;
emp1.employer = comp1;
emp1.save();

var emp2 = new ds.Employee4();
emp2.name = "name2";
emp2.age = 26;
emp2.salary = 1100;
emp2.isManager = false;
emp2.manager = manager1;
emp2.employer = comp1;
emp2.save();

var emp3 = new ds.Employee4();
emp3.name = "name3";
emp3.age = 27;
emp3.salary = 1200;
emp3.isManager = false;
emp3.manager = manager1;
emp3.employer = comp1;
emp3.save();

var emp4 = new ds.Employee4();
emp4.name = "name4";
emp4.age = 28;
emp4.salary = 1300;
emp4.isManager = false;
emp4.manager = manager2;
emp4.employer = comp1;
emp4.save();

//RelatedAlias
var relatedAliasEntity = new ds.RelatedAlias();
relatedAliasEntity.calpha = "alpha_1";
relatedAliasEntity.ctext = "text1 text2" ;
relatedAliasEntity.cdate = new Date("12/30/2013") ;
relatedAliasEntity.ctime = 37356000 ;
relatedAliasEntity.cbool = true ;
relatedAliasEntity.cinteger = 100 ;
relatedAliasEntity.clonginteger = 10000 ;
relatedAliasEntity.cinteger64 = 10000 ;
relatedAliasEntity.creal = 111 ;
relatedAliasEntity.cfloat = 222 ;
relatedAliasEntity.cblob = new Blob(16*1024,0x00FF);
relatedAliasEntity.cpicture = loadImage(path+"img/4D.jpg");
relatedAliasEntity.save();

//HaveAlias
var haveAliasEntity = new ds.HaveAlias();
haveAliasEntity.Link_15 = relatedAliasEntity;
haveAliasEntity.save();

//OldName
for(var i = 1;i<6;i++){
	var newEntity = new ds.OldName();
	newEntity.cstring = "Entity_"+i;
	newEntity.save();
}

//CalculatedAttributes
var firstEntityCalcuAtt = new ds.CalculatedAttributes();
firstEntityCalcuAtt.alpha1 = "alpha4D";
firstEntityCalcuAtt.alpha1 = "alphaWakanda";
firstEntityCalcuAtt.date1 = new Date("06/01/2012");
firstEntityCalcuAtt.date2 = new Date("01/01/2013");
firstEntityCalcuAtt.boolean1 = true;
firstEntityCalcuAtt.boolean2 = false;
firstEntityCalcuAtt.integer1 = 32000;
firstEntityCalcuAtt.integer2 = -30000;
firstEntityCalcuAtt.longInt1 = 47483;
firstEntityCalcuAtt.longInt2 = 47500;
firstEntityCalcuAtt.integer641 = 4611685;
firstEntityCalcuAtt.integer642 = 4611683;
firstEntityCalcuAtt.save();
var secondEntityCalcuAtt = new ds.CalculatedAttributes();
secondEntityCalcuAtt.alpha1 = "alphaOmar";
secondEntityCalcuAtt.alpha1 = "alphaKarim";
secondEntityCalcuAtt.date1 = new Date("03/15/1988");
secondEntityCalcuAtt.date2 = new Date("11/05/2000");
secondEntityCalcuAtt.boolean1 = false;
secondEntityCalcuAtt.boolean2 = true;
secondEntityCalcuAtt.integer1 = 4512;
secondEntityCalcuAtt.integer2 = -4000;
secondEntityCalcuAtt.longInt1 = 454540;
secondEntityCalcuAtt.longInt2 = 525250;
secondEntityCalcuAtt.integer641 = 54612084;
secondEntityCalcuAtt.integer642 = 54671251;
secondEntityCalcuAtt.save();


//WithRestrictingQuery
for(var i = 1 ; i <= 5 ; i++)
{
	var newEntWithRest = new ds.WithRestrictingQuery();
	newEntWithRest.save();
}

//NewEvents
var newEnt_NewEvents = new ds.NewEvents();
newEnt_NewEvents.cstring = "forTest";
newEnt_NewEvents.save();


//IdLong
var newEnt = new ds.IdLong();
newEnt.save();

//Idlong64
var newEnt = new ds.Idlong64();
newEnt.save();

//IdNumber
var newEnt = new ds.IdNumber();
newEnt.save();

//IdString
var newEnt = new ds.IdString();
newEnt.save();

//IdUUID
//Using DataBrowser, create one entity containing ni the ID  this value: 2E7B4F2E0357264EA15ED89C80A2C3DD


//GetModifiedAtt
new ds.GetModifiedAtt().save();
