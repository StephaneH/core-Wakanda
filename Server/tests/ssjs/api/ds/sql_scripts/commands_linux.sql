drop database if exists `testSQLBridge_linux`;
CREATE DATABASE  IF NOT EXISTS `testSQLBridge_linux` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_cs */;
USE `testSQLBridge_linux`;
