drop database if exists `testSQLBridge_mac`;
CREATE DATABASE  IF NOT EXISTS `testSQLBridge_mac` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_cs */;
USE `testSQLBridge_mac`;
