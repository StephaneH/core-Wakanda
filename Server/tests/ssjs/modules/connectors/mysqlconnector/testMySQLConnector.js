...
//          ,testInsertDateWithApi   : true
    ...
    testConnectWithAnInvalidUserNameType: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(hostname, 16, 'saad', '');
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithAnInvalidUserNameValue: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(hostname, 'boot', 'saad', '');
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithAnInvalidPasswordType: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(hostname, 'saad', 12, '');
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithAnInvalidPasswordValue: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(hostname, 'saad', 'boot', '');
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithAnInvalidPortType: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(hostname, 'saad', 'saad', '', '33');
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithAnInvalidPortValue: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(params.hostname, params.user, params.password, '', 33);
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithSSL: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(paramsSSL.hostname, paramsSSL.user, paramsSSL.password, paramsSSL.database, paramsSSL.port, true);
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testConnectWithSSLUsingTrueSSLUserWithFalseArg: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(paramsSSL.hostname, paramsSSL.user, paramsSSL.password, paramsSSL.database, paramsSSL.port, false);
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testCloseLogic: function() {
        ...
        var exceptionMsg = "";
        try {
            var dbconn = mysql.connect(params.hostname, params.user, params.password, params.database, 3306, false);
            if (dbconn) dbconn.close();
    ...
    testGetAffectedRowCountExist: function() {
        ...
        try {
            ...
            var q = 'SELECT * FROM test_select_table';
            var result = dbconn.execute(q);
            if (result.getAffectedRowCount) 
                getAffectedRowCountExist = true;
        }
        catch (err) {
            exceptionOccur = true;
            exceptionMsg = err.message;
    ...
    testSelectDate: function() {
        var exceptionOccur = false;
//        var date1 = new Date("1000/1/1");
//        var date2 = new Date("9999/12/31");
