...
public:
	...
	static	void						AllowDebuggingForContext( XBOX::VJSGlobalContext* inContext);
	static	void						DisallowDebuggingForContext( XBOX::VJSGlobalContext* inContext);
...
private:
	...
	virtual XBOX::VProgressIndicator*		CreateProgressIndicator( const XBOX::VString& inTitle);
			...
			XBOX::VError					_DestroyContext( XBOX::VJSGlobalContext* inContext, XBOX::VJSGlobalObject* inGlobalObject);
	...
	mutable	sLONG							fCreatedContextCount;
	mutable	sLONG							fDestroyedContextCount;
