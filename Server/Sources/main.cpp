...
int main (int inArgc, char * const inArgv[])
{
	...
	VRIAServerApplication::Get()->SetProductVersion(VString(STRPRODUCTVER));	//	YT 18-May-2012 - WAK0076647

	#if IS_WAKANDA_COMMUNITY_SERVER
	VRIAServerApplication::Get()->SetProductName(VString("Wakanda Server"));
	#elif IS_WAKANDA_ENTERPRISE_SERVER
	VRIAServerApplication::Get()->SetProductName(VString("Wakanda Enterprise Server"));
	#endif
