...
#define WITH_SANDBOXED_PROJECT	1

#define ALLOW_CUSTOMIZE_ADMIN_PUBLISHING_OPTIONS	1

#define ALLOW_USE_NEW_ADMIN 1	// if set to 1, if the parameter "use-new-admin" is passed in the command line, the "Wakanda Admin" project will be loaded as the administrator project

#define ACCEPT_ANY_PROJECT_AS_ADMINISTRATOR 1	// if set to 0, the server chooses the administrator project and ignores the "administrator" project setting
