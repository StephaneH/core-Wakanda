...
public:
	...
	static	void			_open( XBOX::VJSParms_callStaticFunction& ioParms, VRIAServerSolution* inSolution);
	static	void			_openRecent( XBOX::VJSParms_callStaticFunction& ioParms, VRIAServerSolution* inSolution);
	...
	static	void			_getRecentlyOpened( XBOX::VJSParms_getProperty& ioParms, VRIAServerSolution* inSolution);
};
