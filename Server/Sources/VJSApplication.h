...
public:
	...
	static void				_getJournalInfo(XBOX::VJSParms_callStaticFunction& ioParms, XBOX::VJSGlobalObject* inGlobalObject); // Object: getJournalInfo([Object: options])
	static void				_resetDataStoreJournal(XBOX::VJSParms_callStaticFunction& ioParms, XBOX::VJSGlobalObject* inGlobalObject); //Object: _resetDataStoreJournal(File: dataFile);
...
public:
	...
	static void				_getJournalInfo(XBOX::VJSParms_callStaticFunction& ioParms, VRIAServerProject* inApplication);// Object: getJournalInfo([Object: options])
	static void				_resetDataStoreJournal(XBOX::VJSParms_callStaticFunction& ioParms, VRIAServerProject* inApplication); //Object: _resetDataStoreJournal(File: dataFile);
...
class VJSSandboxedApplication: public XBOX::VJSClass<VJSSandboxedApplication, VRIAServerProject>
{
public:

	typedef XBOX::VJSClass<VJSSandboxedApplication, VRIAServerProject>	inherited;
