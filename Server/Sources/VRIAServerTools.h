...
private:
			StTaskPropertiesSetter()													{ xbox_assert(false); }
			StTaskPropertiesSetter( const StTaskPropertiesSetter& inSource)				{ xbox_assert(false); }
			StTaskPropertiesSetter& operator=( const StTaskPropertiesSetter& inSource)	{ xbox_assert(false); return *this; }
