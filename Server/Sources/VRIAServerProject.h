...
public:
	...
	static	VRIAServerProject*			OpenProject( XBOX::VError& outError, VRIAServerSolution* inSolution, VProject* inDesignProject, VRIAServerProjectOpeningParameters *inOpeningParameters);
			...
			XBOX::VError				SetDebuggerServer( VRIAContext* inContext, WAKDebuggerType_t inWAKDebuggerType, bool inAsynchronous);
...
private:
	...
	virtual	XBOX::VError				UninitializeJSContext( XBOX::VJSGlobalContext* inContext);
			...
			XBOX::VError				_SetDebuggerServer( WAKDebuggerType_t inWAKDebuggerType);
...
{
public:
	VSetDebuggerServerMessage( VRIAServerProject* inApplication, WAKDebuggerType_t inWAKDebuggerType);
