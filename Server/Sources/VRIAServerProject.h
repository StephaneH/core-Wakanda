...
public:
	...
	virtual ~VRIAServerProjectOpeningParameters();
			...
			void					SetCustomPublishingOptions( EHTTPServerPublishingOptions inPublishingOptions);
			bool					GetCustomPublishingOptions( EHTTPServerPublishingOptions& outPublishingOptions) const;
		#endif
			...
			void					SetIsAdministrator( bool inIsAdministrator);
			bool					GetIsAdministrator() const;
		#endif

#if ALLOW_CUSTOMIZE_ADMIN_PUBLISHING_OPTIONS
	static	bool					PublishingOptionsToHTTPServerSettings( EHTTPServerPublishingOptions inPublishingOptions, bool& outAllowHttps, bool& outHttpsMandatory, bool& outAllowHttpsOnLocal);
#endif
