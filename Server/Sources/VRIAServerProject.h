...
/*
 *	VErrorProcessingHandler to handle custom error pages (404.html, 4.html, 500.html or 5.html)
 */
class VErrorProcessingHandler : public IErrorProcessingHandler
{
public:
                                            VErrorProcessingHandler() {};
    virtual                                 ~VErrorProcessingHandler() {};
	virtual XBOX::VError					ProcessError (XBOX::VError& inError, IHTTPRequestHandler * inHTTPRequestHandler, IHTTPResponse *ioResponse);
};
