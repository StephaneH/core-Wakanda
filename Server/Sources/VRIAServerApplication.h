...
class CHTTPServer;
class VSolution;
class XBOX::VServiceDiscoveryServer;
...
{
public:
			VRIAOpenSolutionAsCurrentSolutionMessage( VRIAServerApplication* inServer, VSolutionStartupParameters *inStartupParameters);
...
class VRIAServerApplication : public XBOX::VDaemon, public IJSContextPoolDelegate
{
...
public:
	...
	virtual	XBOX::VFolder*					RetainFolder( XBOX::VProcess::EFolderKind inSelector) const;
			...
			*/
			XBOX::VError					OpenSolutionAsCurrentSolution( const XBOX::VFilePath& inDesignSolutionFilePath);
			XBOX::VError					OpenSolutionAsCurrentSolution( VSolutionStartupParameters *inStartupParameters);
			...
			*/
			VRIAServerSolution*				OpenAndRetainSolutionForMaintenance( XBOX::VError& outError,  VSolutionStartupParameters *inStartupParameters);
...
private:
	...
	virtual	XBOX::VError					UninitializeJSContext( XBOX::VJSGlobalContext* inContext);
			...
			XBOX::VError					_OpenSolutionAsCurrentSolution( VSolutionStartupParameters *inStartupParameters);
