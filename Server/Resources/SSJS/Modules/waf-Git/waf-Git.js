...
var gitPushImpl = function ( inURL, inRepository, inCallback )
{
	...
	var				gitCommand = _gitGetRepoAndTreeFS ( ) + "push " + inURL + " " + localBranch + ":" + localBranch;
...
var gitRemoveImpl = function ( inArrPaths, inWorkTree )
{
	...
	return _gitExecuteFS ( gitCommand, inParameters, _gitGetRepositoryRootFolder ( ), 10 * 1000, null );
}
...
//debug_alert ( "Unescaped line to consider " + strLine );
	...
	arrLines = _gitExecuteFS ( gitCommand, inParameters, null, 60 * 1000, null );
