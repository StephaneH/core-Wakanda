...
public class TestCasesSelectAPI extends Template {
	...
	@Ignore
	public void testSelect_setErrorMessage() throws InterruptedException
	{
	}
	
	@Ignore
	public void testSelect_clearErrorMessage() throws InterruptedException
	{
	}
	...
	public void testSelect_clear() throws InterruptedException
	{
		...
		String result = (String) js.executeScript("return $$('select1').getValue();");
		assertEquals("Check clear() API", "", result);
	}
