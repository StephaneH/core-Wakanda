...
public class TestCasesGridAPI extends TestCasesTemplateWidget {
	
	public TestCasesGridAPI(eBrowser browserName,String soluString,boolean launchServerOnlyOneTime) {
	...
	@Test
	public void testGrid_getSelectionMode() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("getSelectionMode")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_setSelectionMode_single() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("setSelectionMode_single")).click();
		getWebDriver().findElement(By.id("getSelectionMode")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_setSelectionMode_multiple() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("setSelectionMode_single")).click();
		getWebDriver().findElement(By.id("setSelectionMode_multiple")).click();
		getWebDriver().findElement(By.id("getSelectionMode")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_countSelected() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		JavascriptExecutor js = (JavascriptExecutor) getWebDriver();
		js.executeScript("$('#grid .waf-dataGrid-body .waf-dataGrid-col-name:eq(1)').click();");
		getWebDriver().findElement(By.id("countSelected")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_reduceToSelected() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		JavascriptExecutor js = (JavascriptExecutor) getWebDriver();
		js.executeScript(
		...
		getWebDriver().findElement(By.id("reduceToSelected")).click();
		Thread.sleep(500);
		
		String myEntityNumber = "";
		for (int i=0; i<5 && "5 item(s)" != myEntityNumber; i++){
			myEntityNumber = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[3]/div[2]")).getAttribute("innerHTML");
			Thread.sleep(1000);
		}
	...
	@Test
	public void testGrid_getSortIndicator() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("getSortIndicator")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_setSortIndicator_desc() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("setSortIndicator_desc")).click();
		getWebDriver().findElement(By.id("getSortIndicator")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_setSortIndicator_asc() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("setSortIndicator_asc")).click();
		getWebDriver().findElement(By.id("getSortIndicator")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_resetSortIndicator() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("setSortIndicator_asc")).click();
		getWebDriver().findElement(By.id("resetSortIndicator")).click();
		getWebDriver().findElement(By.id("getSortIndicator")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_column_setFormat() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setFormat")).click();
		Thread.sleep(500);

		String myResult = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[2]/div/div/div/div/div")).getAttribute("innerHTML");
		assertEquals("$1,00", myResult);
	}
	
	@Test
	public void testGrid_column_getFormattedValue() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setFormat")).click();
		getWebDriver().findElement(By.id("column_getFormattedValue")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_column_getValueForInput() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setFormat")).click();
		getWebDriver().findElement(By.id("column_getValueForInput")).click();
		Thread.sleep(500);
	...
	@Test
	public void testGrid_column_setBackgroundColor() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setBackgroundColor")).click();
		Thread.sleep(500);

		String myResult = getWebDriver().findElement(By.xpath("//div[@id='grid']/div/div/div[2]")).getCssValue("background-color").replaceAll("\\s","");
		assertEquals("rgba(204,51,0,1)", myResult);
	}
	
	@Test
	public void testGrid_column_setColor() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setColor")).click();
		Thread.sleep(500);

		String myResult = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[2]/div/div[5]/div/div/div")).getCssValue("color").replaceAll("\\s","");
		assertEquals("rgba(204,51,0,1)", myResult);
	}
	
	@Test
	public void testGrid_column_setRenderer() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setRenderer")).click();
		Thread.sleep(500);

		String myResult = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[2]/div/div/div/div[2]/div")).getAttribute("innerHTML");
		assertEquals("EMP_1", myResult);
	}
	
	@Test
	public void testGrid_column_setTextSize() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setTextSize")).click();
		Thread.sleep(500);

		String myResult = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[2]/div/div/div/div/div")).getCssValue("font-size");
		assertEquals("14px", myResult);
	}
	
	@Test
	public void testGrid_column_setWidth() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("column_setWidth")).click();
		Thread.sleep(500);
		
		String myResult = getWebDriver().findElement(By.xpath("//div[@id='grid']/div/div/div")).getAttribute("offsetWidth");
		assertEquals("150", myResult);
	}
	...
	public void testGrid_hide() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getCssValue("display");
	...
	public void testGrid_addClass() throws InterruptedException
	{
		...
		Boolean myResult = getWebDriver().findElement(By.id("grid")).getAttribute("className").contains("toto");
	...
	public void testGrid_move() throws InterruptedException
	{
		...
		WebElement myElement = getWebDriver().findElement(By.id("grid"));
	...
	public void testGrid_setWidth() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getAttribute("offsetWidth");
	...
	public void testGrid_setHeight() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getAttribute("offsetHeight");
		assertEquals("100", myResult);
	}
	...
	public void testGrid_setLeft() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getAttribute("offsetLeft");
		assertEquals("100", myResult);
	}
	...
	public void testGrid_setRight() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getCssValue("right");
	...
	public void testGrid_setTop() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getAttribute("offsetTop");
		assertEquals("100", myResult);
	}
	...
	public void testGrid_setBottom() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getCssValue("bottom");
		assertEquals("100px", myResult);
	}
	...
	public void testGrid_getPosition() throws InterruptedException
	{
		...
		Boolean myResult = getWebDriver().findElement(By.id("grid")).getAttribute("innerHTML").contains("undefined");
		assertEquals(false, myResult);
	}
	...
	public void testGrid_destroy() throws InterruptedException
	{
		...
		try{
			getWebDriver().findElement(By.id("grid"));
			assertTrue(false);
		}catch(Exception e){}
	}
	
	@Test
	public void testGrid_disable() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		...
		String myInput = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[2]/div/div/div/div[2]/div")).getCssValue("display");
		assertEquals("block", myInput);

		String myToolbar = getWebDriver().findElement(By.xpath("//div[@id='grid']/div[3]/div/ul")).getCssValue("display");
		assertEquals("none", myToolbar);
	}

	@Test
	public void testGrid_enable() throws InterruptedException, FindFailed, IOException, URISyntaxException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
		getWebDriver().findElement(By.id("disable")).click();
	...
	@Test
	public void testGrid_getTheme() throws InterruptedException
	{
		getWebDriver().get("http://127.0.0.1:8081/gridAPI.html");
	...
	public void testGrid_setBackgroundColor() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.xpath("//*[@id='grid']/div[2]")).getCssValue("background-color").replaceAll("\\s","");
	...
	public void testGrid_setTextColor() throws InterruptedException
	{
		...
		String myResult = getWebDriver().findElement(By.id("grid")).getCssValue("color").replaceAll("\\s","");
		assertEquals("rgba(101,0,146,1)", myResult);
	}
	...
	public void testGrid_setParent() throws InterruptedException
	{
		...
		getWebDriver().findElement(By.id("richText1")).findElement(By.id("grid"));
	}
