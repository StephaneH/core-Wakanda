...
// eventHandlers// @lock
	...
	text1.click = function text1_click (event)// @startlock
	{// @endlock
	...
	{// @endlock
		$$('richText1').setValue($$('text1').getValue());
	};// @lock
	...
	{// @endlock
		var myPosition = $$('text1').getPosition();
	...
	{// @endlock
		$$('richText1').setValue($$('text1').getHeight());
	};// @lock

	getWidth.click = function getWidth_click (event)// @startlock
	{// @endlock
		$$('richText1').setValue($$('text1').getWidth());
	};// @lock
	...
	{// @endlock
		$$('text1').resizable(true);
	};// @lock

	draggable.click = function draggable_click (event)// @startlock
	{// @endlock
		$$('text1').draggable(true);
	};// @lock

// @region eventManager// @startlock
	WAF.addListener("text1", "click", text1.click, "WAF");
