...
public class TestCasesSwitchboxAPI extends Template {
	...
	@Ignore
	public void testSwitchbox_setErrorMessage() throws InterruptedException
	{
	}
	
	@Ignore
	public void testSwitchbox_clearErrorMessage() throws InterruptedException
	{
	}
	
	@Test
	public void testSwitchbox_clear() throws InterruptedException
	{
		fDriver.get("http://127.0.0.1:8081/tablet/switchboxAPI.html");
		JavascriptExecutor js = (JavascriptExecutor) fDriver;
		Thread.sleep(500);
		...
		String result = (String) js.executeScript("return $$('switchbox1').getValue() +'';");
		assertEquals("Check clear() API", "false", result);
	}
