package org.wakanda.qa.widgets.radiogroup.api;
...
public class TestCasesRadioAPI extends Template {
	...
	@Ignore
	public void testRadio_setErrorMessage() throws InterruptedException
	{
	}
	
	@Ignore
	public void testRadio_clearErrorMessage() throws InterruptedException
	{
	}
	...
	public void testRadio_clear() throws InterruptedException
	{
		...
		String result = (String) js.executeScript("return $$('radioGroup1').getValue();");
		assertEquals("Check clear() API", "aaa", result);
	}
