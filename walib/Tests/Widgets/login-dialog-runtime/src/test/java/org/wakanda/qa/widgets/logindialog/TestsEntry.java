...
import org.wakanda.qa.widgets.logindialog.api.TestCasesLoginAPI;
import org.wakanda.qa.widgets.logindialog.runtime.TestCasesLoginEvents;
import org.wakanda.wastudio.common.Paths;
import org.wakanda.wastudio.common.Utils;

@RunWith(Suite.class)
@Suite.SuiteClasses({
	TestCasesLoginAPI.class,
	TestCasesLoginEvents.class
})
