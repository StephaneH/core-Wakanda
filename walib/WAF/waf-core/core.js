(function(global) {
    ...
    /**
     * Return the element if found into the array, using the callback and optional thisArg as context
     * Return undefined if the key isn't found
     * @param {array} array to operate on
     * @param {function} callback to call for each element
     * @param {any} thisArg context used to execute the callback
     * @return {any} found element or undefined
     * NOTE: this method follows ES6 Array.find, see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/find
     */
    WAF.find = function(array, callback, thisArg) {
    ...
    function require(name) {
        ...
        throw 'Can\'t find module "' + name[0] + '".';
    }
    ...
    function define(name, requires, func) {
        ...
        requires = (requires || []).map(function(moduleToLoad) {
            return WAF.require(moduleToLoad);
        });
