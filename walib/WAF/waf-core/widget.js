...
WAF.define('waf-core/widget', function() {
    ...
    BaseWidget.addMethods(/** @lends BaseWidget.prototype */ {
        ...
        _getId: function() {
            var i; 
            do {
                i = this.constructor.idPrefix + widgetCounter[this.constructor.idPrefix]++;
    ...
    exports.create = function createWidget(name, base, proto) {
        ...
        _class.idPrefix = name[0].toLowerCase() + name.substr(1);
        if(!(_class.idPrefix in widgetCounter)) {
            widgetCounter[_class.idPrefix] = 1;
        }
        return _class;
    };
