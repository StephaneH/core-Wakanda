...
moduleDescribe('waf/core-widget', function() {
    describe('Widget', function() {
        ...
        describe('.inherit(klass)', function() {
            // FIXME: see why the test below fail
        ...
        describe('.instanceFromDom(node)', function() {
            ...
            it("should throw if the package doesn't exists", function() {
                expect(function() {
                    Widget.instanceFromDom(h('<div id="w1" data-type="W1" data-package="W1hdhdd"></div>'));
                }).to.throw;
            });
